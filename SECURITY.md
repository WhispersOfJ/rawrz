...
The Bear Cave stack is LAN-oriented and intentionally slim: nginx provides internal
TLS ingress, while there is not yet a central authentication tier or monitoring sidecar. Host firewalling and
